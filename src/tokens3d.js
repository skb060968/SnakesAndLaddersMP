...
const ELEV = THREE.MathUtils.degToRad(70);   // camera elevation above the board (90 = top-down disc, lower = more profile)
const SIN = Math.sin(ELEV);
const PAWN_H = 2.5;                          // pawn height in token-size units
